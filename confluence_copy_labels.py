...
CONFLUENCE_URL = environ.get("https://confluence.amd.com/display/DCGPUVAL/BKC+ROW+2.7.0")
CONFLUENCE_LOGIN = environ.get("username")
CONFLUENCE_PASSWORD = environ.get("password")
